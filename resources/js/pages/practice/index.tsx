                                ...
                                sets.map((set) => (
                                    ...
                                    >
                                        <div className="flex flex-1 flex-col min-w-0">
                                            ...
                                            <span className="text-xs text-muted-foreground">{set.words_count} words</span>
                                        </div>
