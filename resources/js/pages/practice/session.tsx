...
import {
  FeedbackBar,
} from '@/components/practice/FeedbackBar'
import {
  MatchingExercise,
} from '@/components/practice/MatchingExercise'
import {
  MultipleChoiceExercise,
} from '@/components/practice/MultipleChoiceExercise'
import {
  ResultsScreen,
} from '@/components/practice/ResultsScreen'
import {
  TypingExercise,
} from '@/components/practice/TypingExercise'
import {
  Card,
  CardContent,
    ...
    return (
      <>
        ...
        <div className="flex h-full flex-1 flex-col items-center gap-6 p-4 pt-10">
          ...
          <ResultsScreen session={session} results={results} />
        </div>
      </>
    )
  }
